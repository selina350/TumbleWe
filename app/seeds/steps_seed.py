...
def seed_steps():
    step1 = Step(
        applicationId=1, name='step1', imageUrl="step", selector="selector")
    step2 = Step(
        applicationId=1, name='step2',imageUrl="step", selector="selector")
    step3 = Step(
        applicationId=2, name='step3',imageUrl="step", selector="selector")
